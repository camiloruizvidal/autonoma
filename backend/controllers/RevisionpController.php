...
use backend\models\RevisionpSearch;
...
class RevisionpController extends Controller
{
    ...
    public function actionSeguimiento()
    {
      ...
      $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
      $sql = 'SELECT
      proyecto.nombre AS Proyecto, revisonp.descripcion, revisonp.correccion, revisonp.archivo, revisonp.estado
   FROM
     revisonp
     INNER JOIN proyecto ON proyecto.idproyecto = revisonp.idproyecto
