...
<table width="100%"><tr>
<td width="50%" style="color:#0061a2" ><span style="font-weight: bold; font-size: 14pt;">Directores</span><br />Calle 5 No. 3-85 Popayán<br />Colombia Código ICFES 2849<br/><span style="font-size: 15pt;">&#9742;</span> PBX: 8213000 - Fax: 8214000</td>
...
<b>Total Resultados:</b> <?php echo $contador; ?>
 ...
 <thead>
 <tr>
<td width="25%", color="white">Proyecto</td>
 <td width="25%", color="white">Director de Grado</td>
 <td width="25%", color="white">Fecha</td>
 <td width="25%", color="white">Cantidad de proyectos</td>
 ...
 <tr>
   ...
   <td align="center">
   <?php echo $row->cantida_de_proyecto; ?>
   </td>
