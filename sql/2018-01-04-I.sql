...
AUTO_INCREMENT=72 AVG_ROW_LENGTH=356 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
COMMENT=''
;
...
AUTO_INCREMENT=34 AVG_ROW_LENGTH=655 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=7 AVG_ROW_LENGTH=2730 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
#
# Data for the `jurado` table  (LIMIT -493,500)
#
...
INSERT INTO `tbl_config` (`id_config`, `name`, `value`) VALUES 
  (1,'alertas','{\"rojo\":{\"inicio\":0,\"fin\":15},\"naranja\":{\"inicio\":16,\"fin\":30},\"verde\":{\"inicio\":31,\"fin\":999999}}');
COMMIT;
