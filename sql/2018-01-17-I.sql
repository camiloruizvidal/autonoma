...
AUTO_INCREMENT=76 AVG_ROW_LENGTH=356 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
COMMENT=''
;
...
CREATE TABLE `anteproyecto` (
  ...
  `aprobado_secretaria` INTEGER(11) DEFAULT 0 COMMENT '0 No ha sido aprobado por el secretario\r\n1 Si ha sido aprobado por el secretario',
...
AUTO_INCREMENT=36 AVG_ROW_LENGTH=1820 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=12 AVG_ROW_LENGTH=1638 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
CREATE TABLE `jurado` (
  ...
  `nombre` VARCHAR(45) COLLATE utf8_general_ci NOT NULL,
  `id_usuario_jurado` INTEGER(11) DEFAULT NULL,
...
CREATE TABLE `jurado_has_proyecto` (
  `id_jurado_has_proyecto` INTEGER(11) NOT NULL AUTO_INCREMENT,
  `idproyecto` INTEGER(11) NOT NULL,
  `idjurado` INTEGER(11) NOT NULL,
  `idjurado2` INTEGER(11) NOT NULL,
  PRIMARY KEY (`id_jurado_has_proyecto`),
  UNIQUE KEY `idproyecto` (`idproyecto`),
  UNIQUE KEY `jurado_has_proyecto_idx1` (`idproyecto`, `idjurado`, `idjurado2`),
...
CREATE TABLE `revisonp` (
  ...
  `num_revisiones` INTEGER(11) NOT NULL,
  `idproyecto` INTEGER(11) NOT NULL,
  `secretario_aprobado` VARCHAR(20) COLLATE utf8_general_ci DEFAULT 'no',
...
#
# Data for the `user` table  (LIMIT -449,500)
#
...
INSERT INTO `user` (`id`, `nombre`, `apellido`, `codigo_estudiantil`, `facultad`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `status`, `created_at`, `updated_at`, `cont`, `fecha_fin`) VALUES 
  (10,'hector','ricardo','12833737','Ing. Sistemas informatico','ricardo','UOpWFVTf-jrrQ6tZAERM_puxZxWtVbcR','$2y$13$2B7nOIiPsFrsW2rqdqQ57ef358ZIrsz/RhftxYj3KRR9WHeCvTLaW',NULL,'rit@gmail.com','Activo','2017-04-10','2017-09-08',1,'2018-04-12'),
  ...
  (36,'Andres','Cifuentes','1061772382','Ing. Sistemas informatico','andres','hX3qwBqRDz0uFa6tqvl7pffZXHa8AIAh','$2y$13$fRd.q4lQbv3NfuMJ2lSLseONF5F5UlwLU6T8IO5vhOgcLaBkUagnG',NULL,'octavio.c@uniautonoma.edu.co','Activo','2017-10-09','2017-10-24',1,'2018-01-04'),
  ...
  (40,'Camilo','Ruiz Vidal','3294828234','Ing. Sistemas informatico','camilo','nhmJ7LfJQbag1axcaDOJUyAPEiP6lLaT','$2y$13$WBQE9WQYmfKm8Fn92B79dO6kLzIdrAevc5sIa0stSy/0tJ41GLuGO',NULL,'camilo@uniautonoma.edu.co','Activo','2017-10-09','2017-10-09',1,'2018-10-09'),
...
#
# Data for the `auth_assignment` table  (LIMIT -449,500)
#
...
#
# Data for the `director_proyecto` table  (LIMIT -494,500)
#
...
#
# Data for the `proyecto` table  (LIMIT -488,500)
#
...
INSERT INTO `proyecto` (`idproyecto`, `nombre`, `descripcion`, `archivo_proyecto`, `date_create`, `id`, `articulo`, `estado`, `objetivos`, `planteamiento_problema`, `justificacion`) VALUES 
  ...
  (3,'andres proyecto','este proyecto se enfoca en la optimización.','proyecto/andres proyecto.txt','2017-10-25 13:10:35',36,'articulo/andres proyecto.txt',0,NULL,NULL,NULL),
  (4,'plataforma para la gestion y seguimiento','esto sirve para optimizar tiempo y dinero','proyecto/plataforma para la gestion y seguimi','2017-11-07 19:11:59',53,'articulo/plataforma para la gestion y seguimiento.docx',0,NULL,NULL,NULL),
  (5,'plataforma para la gestion y seguimiento','sjadhjasdhkj','proyecto/plataforma para la gestion y seguimi','2017-11-07 19:11:08',53,'articulo/plataforma para la gestion y seguimiento.txt',0,NULL,NULL,NULL),
  ...
  (10,'191919191919','191919191919','proyecto/191919191919.pdf','2018-01-12 23:47:40',73,'articulo/191919191919.pdf',1,NULL,NULL,NULL),
  (11,'Prueba arbol de seguimiento','Prueba de seguimiento','proyecto/Prueba arbol de seguimiento.sql','2018-01-14 22:01:15',73,'articulo/Prueba arbol de seguimiento.sql',0,NULL,NULL,NULL);
COMMIT;
...
#
# Data for the `evento` table  (LIMIT -491,500)
#
...
INSERT INTO `evento` (`idevento`, `titulo`, `descripcion`, `fecha`) VALUES 
  ...
  (3,'prueba','','2017-12-07'),
  (4,'prueba de descripcion','','2018-01-13'),
  (6,'lfksdf','lkdsfs','2018-01-01'),
  (8,'titulo','descripcion','2018-01-07'),
  (9,'prueba','prueba descripcion','2018-01-11'),
  (10,'milo','prueba','2018-01-13');
COMMIT;

#
# Data for the `jurado` table  (LIMIT -490,500)
#

INSERT INTO `jurado` (`idjurado`, `nombre`, `id_usuario_jurado`) VALUES 
  (1,'henry',NULL),
  (2,'jimmy',NULL),
  (3,'andres',NULL),
  (4,'camilo ruiz',NULL),
  (5,'pepito perez',NULL),
  (6,'gabriel osorio',29),
  (7,'Jimmy hendrix',NULL),
  (8,'jurado de prueba',74),
  (9,'Jurado de prueba 2',74);
COMMIT;
...
INSERT INTO `jurado_has_proyecto` (`id_jurado_has_proyecto`, `idproyecto`, `idjurado`, `idjurado2`) VALUES 
  (1,2,6,2),
  (2,3,2,1),
  (3,6,1,2),
  (4,7,1,3),
...
#
# Data for the `revision` table  (LIMIT -485,500)
#
...
INSERT INTO `revision` (`idrevision`, `descripcion`, `correccion`, `archivo`, `estado`, `num_revisiones`, `date_create`, `idanteproyecto`, `id_comite`) VALUES 
  ...
  (14,'prueba','<p>aceptado</p>','Revisiones/prueba.pdf','Aceptado',1,'2018-01-17 21:42:12',35,NULL);
COMMIT;

#
# Data for the `revisonp` table  (LIMIT -489,500)
#

INSERT INTO `revisonp` (`idrevisonp`, `descripcion`, `correccion`, `archivo`, `estado`, `num_revisiones`, `idproyecto`, `secretario_aprobado`) VALUES 
  (1,'bien','excelente','RevisionesP/bien.docx','Aprobado',1,1,'no'),
  (2,'bien denis','esta excelente','RevisionesP/bien denis.docx','Aprobado',1,2,'no'),
  (3,'excelente andres','no tienes nada que corregir','RevisionesP/excelente andres.txt','Aprobado',1,3,'no'),
  (4,'falta','no esta bien','RevisionesP/falta.docx','Corrección',2,7,'no'),
  (5,'gfhfgh','ghfgh','RevisionesP/gfhfgh.docx','Corrección',1,7,'no'),
  (6,'Perfecto Santiago','Está perfecta Santiago','RevisionesP/Perfecto Santiago.docx','Aprobado',1,8,'no'),
  (7,'esta bien','pasaste de una','RevisionesP/esta bien.docx','Aprobado',1,9,'no'),
  (8,'Prueba de revision, solo debe ver el secretar','Solo el secretario puede ver esta revision','RevisionesP/Prueba de revision, solo debe ver','Corrección',2,10,'si'),
  (9,'Revision 2, solo secretario','Prueba','RevisionesP/Revision 2, solo secretario.sql','Corrección',1,10,'si'),
  (10,'prueba 4','prueba','RevisionesP/prueba 4.sql','Corrección',1,10,'si');
COMMIT;
...
#
# Data for the `tbl_config` table  (LIMIT -498,500)
#

INSERT INTO `tbl_config` (`id_config`, `name`, `value`) VALUES 
  (1,'alertas','{\"rojo\":{\"inicio\":-1000000,\"fin\":15},\"naranja\":{\"inicio\":16,\"fin\":30},\"verde\":{\"inicio\":31,\"fin\":999999}}');
COMMIT;
