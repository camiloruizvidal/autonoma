...
AUTO_INCREMENT=76 AVG_ROW_LENGTH=334 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
COMMENT=''
;
...
AUTO_INCREMENT=36 AVG_ROW_LENGTH=1755 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AVG_ROW_LENGTH=372 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
COMMENT=''
;
...
AUTO_INCREMENT=11 AVG_ROW_LENGTH=1638 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=15 AVG_ROW_LENGTH=1365 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
#
# Data for the `proyecto` table  (LIMIT -489,500)
#
...
INSERT INTO `revision` (`idrevision`, `descripcion`, `correccion`, `archivo`, `estado`, `num_revisiones`, `date_create`, `idanteproyecto`, `id_comite`) VALUES 
  ...
  (14,'prueba','<p>aceptado</p>','Revisiones/prueba.pdf','Aceptado',1,'2018-01-13 04:01:32',35,NULL);
COMMIT;

#
# Data for the `revisonp` table  (LIMIT -491,500)
#
