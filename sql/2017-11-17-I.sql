...
INSERT INTO `anteproyecto` (`idanteproyecto`, `nombre`, `descripcion`, `archivo_anteproyecto`, `estado`, `alerta`, `date_create`, `idmodalidad`, `id`) VALUES 
  ...
  (8,'ksdks','dfdsf','anteproyecto/ksdks.docx',1,1,'2017-11-17 16:29:02',2,30),
...
INSERT INTO `documento` (`iddocumento`, `nombre`, `archivo`, `id_documento_tipo`, `fecha`) VALUES 
  ...
  (2,'Formato No. 1_Presentacio?n del Anteproyecto de Trabajo de Grado','Archivo/Formato No. 1_Presentacio?n del Anteproyecto de Trabajo de Grado.docx',1,'2017-11-17 11:50:25'),
